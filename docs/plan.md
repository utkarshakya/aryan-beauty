...
## Phase 2 — Learn From Real Usage

Use the product with real people and improve it based on actual problems.

- Fix usability problems
- Improve the booking experience
- Improve the owner's workflow
- Add customer management where it is genuinely useful
- Add notifications or payments when they solve a real need

**Goal:** Make the product reliable and genuinely useful to the parlor.
